...
Computer Engineering student focused on Robotics & Autonomous Systems. <\br>
...
- Python (Automation & Robotics Scripting)
- Bash (Linux System Operations)

## 🧩 Robotics Libraries
- rclcpp (ROS2 C++ Client Library)
- rclpy (ROS2 Python Client Library)
- Eigen (Linear Algebra for Robotics)
...
- Docker (Containerized Robotics Environments)
- CMake / Colcon (Build Tools)
